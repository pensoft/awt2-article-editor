...
import { bullet_list, list_item, ordered_list } from "../Schema/nodes/lists"
...
export function addListNodes(nodes: OrderedMap<NodeSpec>, itemContent: string, listGroup?: string): OrderedMap<NodeSpec> {
  return nodes.append({
    ordered_list: add(ordered_list, {content: "list_item+", group: listGroup}),
    bullet_list: add(bullet_list, {content: "list_item+", group: listGroup}),
    list_item: add(list_item, {content: itemContent})
  })
}
